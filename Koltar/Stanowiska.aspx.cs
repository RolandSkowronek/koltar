...
namespace stat2018
{
    public partial class Stanowiska : System.Web.UI.Page
    {
        ...
        protected void ASPxGridView1_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
        {
            ...
            cm.log.Info("usuwanie stanowiska");
            DataTable parametry =cm. makeParameterTable();
            parametry.Rows.Add("@stanowisko", nowaWartosc01);

           cm. runQuerry(" delete from stanowiska where   nazwa = @stanowisko ", cm.con_str, parametry);

            cm.log.Info("dodawanie stanowiska");
             parametry = cm.makeParameterTable();
            parametry.Rows.Add("@stanowisko", nowaWartosc01);
            cm.runQuerry(" IF NOT EXISTS(SELECT * FROM stanowiska WHERE  nazwa = @stanowisko)    BEGIN  insert INTO Stanowiska(NAZWA) VALUES  (@stanowisko)    END",cm. con_str, parametry);
