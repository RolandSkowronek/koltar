...
namespace stat2018
{
    public partial class oczc : System.Web.UI.Page
    {
        ...
        public void AddNewRow(object sender, GridViewRowEventArgs e)
        {
            ...
            // nowy wiersz
            int idWiersza = 1;
            GridView1.Controls[0].Controls.AddAt(e.Row.RowIndex + rowIndex, tb.wierszTabeli(tabelka01, 17, idWiersza, idtabeli, "zaległości z poprzedniego miesiąca", 2, 0, "", "borderAll center"));
            ...
            // nowy wiersz
            idWiersza = 3;
            GridView1.Controls[0].Controls.AddAt(e.Row.RowIndex + rowIndex, tb.wierszTabeli(tabelka01, 17, idWiersza, idtabeli, "Załatwienie", 2, 0, "", "borderAll center"));

            // nowy wiersz
            idWiersza = 4;
            GridView1.Controls[0].Controls.AddAt(e.Row.RowIndex + rowIndex, tb.wierszTabeli(tabelka01, 17, idWiersza, idtabeli, "Pozostało na miesiąc następny", 2, 0, "", "borderAll center"));
